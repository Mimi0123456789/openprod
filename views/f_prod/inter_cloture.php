...
$interventions = $fInterModel->getClotureAvecDetails();
      ...
      <tbody>
        ...
        ?>
          ...
          <tr>
            ...
            <td>
<?php
$idPdf = (int)($donnees['id'] ?? 0);
?>

<a
    href="index.php?c=transverse&a=generate_inter_pdf&id_inter=<?php echo $idPdf; ?>"
    target="_blank"
...
<?php
$idZip = (int)($donnees['id'] ?? 0);
?>

<a
    href="index.php?c=transverse&a=download_inter_zip&id_inter=<?php echo $idZip; ?>"
