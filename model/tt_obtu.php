...
require_once(ROOT_PATH . "/dao/tt_obtu.php");
...
class tt_obtuModel
{
    ...
    public function add($tt_obtu)
    {
        return $this->dao->add($tt_obtu);
    }

    public function update($tt_obtu)
    {
        return $this->dao->update($tt_obtu);
    }
